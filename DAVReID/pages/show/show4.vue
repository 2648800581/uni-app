		...
		<div class="content">
			...
			<div class="image-container">
				<img v-for="(image, index) in images" :key="index" :src="image.src"
					...
					:class="{ 'image': true, 'green-border': index > 0 }" />
			</div>
		</div>
	</div>
</template>
	...
	export default {
		data() {
			return {
				...
				images: [{
						src: '/static/Ve_04_q.png', // 更改为目标查询图像的路径
						displayed: true // 直接显示，无需等待
					},
					{
						src: '/static/vehicle/v-4-1.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-4-2.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-4-3.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-4-4.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-4-5.png',
						displayed: false
					}
				]
			};
