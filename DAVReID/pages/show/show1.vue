	...
	export default {
		data() {
			return {
				...
				images: [{
						src: '/static/Ve_01_q.png', // 更改为目标查询图像的路径
						displayed: true // 直接显示，无需等待
					},
					{
						src: '/static/vehicle/v-1-1.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-1-2.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-1-3.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-1-4.png',
						displayed: false
					},
					{
						src: '/static/vehicle/v-1-5.png',
						displayed: false
					}
				]
			};
